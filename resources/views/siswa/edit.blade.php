	...
	<div class="main">
		<div class="main-content">
		  ...
		  <div class="form-group">
			...
			<div class="form-group">
			    <label for="exampleFormControlSelect1">Pilih Jenis Kue</label>
			    <select name="jenis_kelamin" class="form-control" id="exampleFormControlSelect1">
			      <option value="L" @if($siswa -> jenis_kue == 'B') selected @endif>Basah</option>
			      <option value="P" @if($siswa -> jenis_kue == 'K') selected @endif>Kering</option>
			    </select>
			  </div>
